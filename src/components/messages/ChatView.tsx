  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-4 py-4 bg-zinc-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900/40 via-zinc-950 to-black scroll-smooth"
      >
        {messages.length === 0 ? (
