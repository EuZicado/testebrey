   ...
   return (
     ...
     >
       <div className="relative group">
         {/* Main PiP window */}
         <motion.div 
           className="w-36 h-48 rounded-2xl overflow-hidden bg-card border-2 border-white/20 shadow-2xl"
           onClick={onExpand}
         ...
         >
           ...
           {/* Duration badge */}
           <div className="absolute bottom-2 left-2 bg-background/80 backdrop-blur-sm px-2 py-0.5 rounded-full">
